...
echo ""
echo "Задание"
echo "052_Counting_Rows"
echo "Авторство и время выполнения задания"
who i am
date
echo ""
echo "Содержание скрипта"
cat 052_Counting_Rows.sql
echo ""
echo ""
echo "Результаты"
mysql -ug01u00 -pmysql16 --table g01u00 < 052_Counting_Rows.sql  > ../tmp/052_Counting_Rows.txt
cat ../tmp/052_Counting_Rows.txt
